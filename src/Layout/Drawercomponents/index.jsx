...
function DrawerComponent(props) {
  ...
  const menu = [
    { path: "/dashboard", title: "Dashboard", icon: <GoKey /> },
    { path: "/product", title: "Products", icon: <HiOutlineCube /> },
    { path: "/customers", title: "Customers", icon: <BsPersonSquare /> },
    { path: "/income", title: "Income", icon: <BiSolidWalletAlt /> },
    { path: "/promote", title: "Promote", icon: <LuBadgePercent /> },
    { path: "/help", title: "Help", icon: <TbHelpSquareRoundedFilled /> },
  ];
  React.useEffect(() => {
